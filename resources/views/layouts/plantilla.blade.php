...
<html lang="en">
   ...
   <body class="main-layout">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="header_information">
                           <ul>
                              <li><img src="images/1.png" alt="#"/> ubicacion</li>
      ...
      <section > <!-- inicio de destinos -->
         <div class="banner-main">
            <img src="images/banner.jpg" alt="#"/>
            <div class="container">
               <div class="text-bg">
                  <h1>Tour Increible de<br><strong class="white">Santa Barbara</strong></h1>
                  <div class="button_section"> <a class="main_bt" href="#">Leer más</a>  </div>
                  <div class="container">
